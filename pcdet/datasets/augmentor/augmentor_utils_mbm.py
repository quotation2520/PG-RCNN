...
def random_flip_along_x(gt_boxes, points, bm_points):
    """
    Args:
...
def random_flip_along_y(gt_boxes, points, bm_points):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C)
...
def global_rotation(gt_boxes, points, bm_points, rot_range):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C),
...
def global_scaling(gt_boxes, points, bm_points, scale_range):
    """
    Args:
