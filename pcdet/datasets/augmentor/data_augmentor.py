...
class DataAugmentor(object):
    ...
    def random_world_flip_mbm(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            gt_boxes, points, bm_points = getattr(augmentor_utils_mbm, 'random_flip_along_%s' % cur_axis)(
                gt_boxes, points, bm_points
            )
    ...
    def random_world_rotation_mbm(self, data_dict=None, config=None):
        ...
        gt_boxes, points, bm_points = augmentor_utils_mbm.global_rotation(
    ...
    def random_world_scaling_mbm(self, data_dict=None, config=None):
        ...
        gt_boxes, points, bm_points = augmentor_utils_mbm.global_scaling(
            data_dict['gt_boxes'], data_dict['points'], data_dict['bm_points'], config['WORLD_SCALE_RANGE']
        )
        data_dict['gt_boxes'] = gt_boxes
        data_dict['points'] = points
        data_dict['bm_points'] = bm_points
    ...
    def random_local_noise_mbm(self, data_dict=None, config=None):
        ...
        augmentor_utils_mbm.noise_per_object_v3_(data_dict['gt_boxes'], data_dict['points'], data_dict['bm_points'], 
