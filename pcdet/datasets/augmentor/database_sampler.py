...
#            empty_boxes_idx = box_utils.find_point_empty_boxes3d_index(data_dict['points'], data_dict['gt_boxes'])
#            data_dict['gt_boxes'] = data_dict['gt_boxes'][~empty_boxes_idx]
#            data_dict['gt_boxes2d'] = data_dict['gt_boxes2d'][~empty_boxes_idx]
#            data_dict['gt_names'] = data_dict['gt_names'][~empty_boxes_idx]
        return data_dict
