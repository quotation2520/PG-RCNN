...
class AddBestMatch(object):
    def __init__(self, root_path, sampler_cfg, class_names, logger=None):
        ...
        self.bmatch_infos = {}
        self.mlt_bm_root = {
            "Car":self.root_path.resolve() / sampler_cfg.CAR_MLT_BM_ROOT,
            "Cyclist":self.root_path.resolve() / sampler_cfg.CYC_MLT_BM_ROOT,
            "Pedestrian":self.root_path.resolve() / sampler_cfg.PED_MLT_BM_ROOT,
        }
        self.vis = False
